# DevBrain-CQUPT 功能总结文档

## 一、项目概述

DevBrain-CQUPT 是一个面向高校和企业的智能知识库管理平台，采用 RAG（检索增强生成）架构，将非结构化文档（PDF、Office、Markdown 等）转化为可语义搜索的结构化知识。
...
5. （待实现）将检索结果作为上下文注入 LLM Prompt，生成最终回答
